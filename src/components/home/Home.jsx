...
function CartIcon(){
    ...
    return (<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='cart-icon'>
                <g strokeWidth="0"></g>
...
//     useEffect(async () => {
//       fetch('https://pyapp.dsx4.repl.co/suggestion/addnew', {
//   method: "post",
//   headers: {
...
//     }, [])
    ...
    return (
        <>
              ...
              <img src={logo} aria-hidden='true' className='background-logo'/>
              <img src={logo} className='foreground-logo'/>
              </div>
          <h1 className='homepage-title'>PyApps</h1>
              <p className='text-center'>Here you will get some specific use case windows apps.</p>
            <button className='homepage-gotostore-btn' >
              <NavLink to='/store' >
